...
class DoipTp(iTp):
    ...
    def __init__(self, configPath=None, **kwargs):
        ...
        self.__auto_reconnect_tcp = self.__config["DoIP"]["autoReconnect"] == 'True'
    ...
    def resetConnection(self, delay_time):
        self.__connection.reconnect(delay_time)
    ...
    def __checkKwargs(self, **kwargs):
        ...
        if 'auto_reconnect_tcp' in kwargs:
            self.__config['DoIP']['autoReconnect'] = 'True' if kwargs['auto_reconnect_tcp'] else 'False'